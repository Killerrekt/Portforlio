  ...
  return (
    <div className="window" ref={ref}>
      ...
      <div className="content">
        ...
        keen interest in writing high-quality, efficient, and scalable solutions
        to complex problems. <br /> <br />
        My journey into the world of software development began since 6th
        standard. Since then, I've been on an exciting quest to continuously
        learn and grow, embracing new technologies, methodologies, and best
        practices along the way. I specialize in backend development and
        databases.
      </div>
    </div>
  );
