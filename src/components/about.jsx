    ...
    <div ref={ref}>
      <div className="window">
        ...
        <div className="content">
          Hello! I'm Aman, a passionate and dedicated software developer with a
          keen interest in crafting high-quality, efficient, and scalable
          solutions to complex problems. I have had the opportunity to work on a
          variety of projects across web development. <br /> <br />
          My journey into the world of software development began since 6th
          standard through QBasic. Since then, I've been on an exciting quest to
          continuously learn and grow, embracing new technologies,
          methodologies, and best practices along the way. I specialize in
