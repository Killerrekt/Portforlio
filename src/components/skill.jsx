    ...
    <div ref={ref}>
      <div className="window">
        <div className="heading">
          <span className="headingtext">Skills</span>
          <div className="icon">
            <svg
              version="1.1"
              id="Layer_1"
        ...
        <div className="content">
          ...
          <span style={{ marginLeft: "5%" }}>
            Go, JavaScript, TypeScript, SQL, NoSQL, Python, C,
          </span>
          <br />
          <span style={{ marginLeft: "5%" }}>C++, Java</span>
          <br /> <br />
          Frameworks and Library :-
          <br />
          <span style={{ marginLeft: "5%" }}>
            Go Fiber, Echo, Express JS, Next JS, Flask,
          </span>
          <br />
          <span style={{ marginLeft: "5%" }}>
            FastAPI, Oauth2.0, S3, Selenium, Beautiful Soup
          </span>
          <br />
          <br />
          Tools :-
